        ...
        <Carousel responsive={responsive}>
          {products.length > 0 ? (
            products.map((product) => (
              <div className="m-2 bg-white rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-xl relative group" key={product.productId}>
                {product.imageURL && (
